...
router.patch('/:id/image', requireAuth, ListingsController.setListingImage);
router.patch('/:id', requireAuth, requireAdmin, ListingsController.updateListing);
router.delete('/:id', requireAuth, requireAdmin, ListingsController.deleteListing);
